...
export interface ApiCareLogCareLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    careType: Schema.Attribute.Enumeration<
      ['watering', 'fertilizing', 'pruning', 'repotting', 'other']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPlantPlant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    acquiredDate: Schema.Attribute.Date;
    care_logs: Schema.Attribute.Relation<'oneToMany', 'api::care-log.care-log'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    humidity: Schema.Attribute.Enumeration<['low', 'medium', 'high']>;
    isToxicToPets: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    lightLevel: Schema.Attribute.Enumeration<['low', 'medium', 'high']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    species: Schema.Attribute.String & Schema.Attribute.Required;
    temperaturePreference: Schema.Attribute.Enumeration<
      ['cold', 'moderate', 'warm']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
